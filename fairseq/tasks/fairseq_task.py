...
class FairseqTask(object):
    ...
    def build_generator(
        ...
        from fairseq.sim_sequence_generator import SimSequenceGenerator
        ...
        if seq_gen_cls is None:
            ...
            elif getattr(args, "sim_decoding", False):
                seq_gen_cls = SimSequenceGenerator
            else:
    ...
    def train_step(
        ...
        with torch.autograd.profiler.record_function("forward"):
            loss, sample_size, logging_output = criterion(model, sample, update_num=update_num, valid=False)
        if ignore_grad:
            loss *= 0
